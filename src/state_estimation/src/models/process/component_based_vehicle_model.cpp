...
ComponentBasedVehicleModel::ComponentBasedVehicleModel(SEParameters parameters)
  ...
  this->load_transfer_model_ =
      load_transfer_models_map.at(parameters.load_transfer_model_name_)(parameters.car_parameters_);
