...
void PacsimAdapter::init() {
  ...
  this->_pacsim_wheel_speeds_subscription_.subscribe(this->node, "/pacsim/wheelspeeds");
  this->_steering_angle_subscription_.subscribe(this->node, "/pacsim/steeringFront");
  ...
  if (this->node->_use_simulated_perception_) {
    this->_perception_detections_subscription_ =
        this->node->create_subscription<pacsim::msg::PerceptionDetections>(
...
void PacsimAdapter::wheel_speeds_subscription_callback(
  ...
  this->node->_wheel_speeds_subscription_callback(wheels_msg.rl, wheels_msg.fl, wheels_msg.rr,
