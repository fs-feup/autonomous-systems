...
TEST(ODOMETRY_SUBSCRIBER, CONVERSION_TEST) {
  ...
  MotionUpdate velocity_data = SENode::odometry_to_velocities_transform(
  ...
  velocity_data = SENode::odometry_to_velocities_transform(lb_speed, rb_speed, lf_speed, rf_speed,
                                                           steering_angle);
  ...
  rf_speed = 60;
  steering_angle = -M_PI / 8;
  MotionUpdate velocity_data_2 = SENode::odometry_to_velocities_transform(
      lb_speed, rb_speed, lf_speed, rf_speed, steering_angle);
