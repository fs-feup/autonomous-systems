...
std::string VEParameters::load_config() {
 ...
 std::string car_config_par = common_lib::config_load::get_config_yaml_path(
    "velocity_estimation", "car", adapter);
  ...
  this->car_parameters_.wheelbase = 
      ve_config["velocity_estimation"]["wheel_base"].as<double>();
  this->car_parameters_.rear_axis_to_camera =
      car_config["car"]["rear_axis_to_camera"].as<double>();
  this->car_parameters_.axis_length =
      car_config["car"]["axis_length"].as<double>();
    
  this->car_parameters_.dist_cg_2_rear_axis =
      car_config["car"]["dist_cg_2_rear_axis"].as<double>();
