...
/**
 * @brief Test the constant acceleration and turnrate model with a straight line movement in the x
 * axis
 * - positive vx
 */
...
/**
 * @brief Test the constant acceleration and turnrate model with a backwards movement in the x axis
 * - negative vx
 */
...
/**
 * @brief Test the constant acceleration and turnrate model for angle cap on the orientation update
 * - 2PI
 */
...
/**
 * @brief Test the constant acceleration and turnrate model in a curvilinear movement with a
...
/**
 * @brief Test the constant acceleration and turnrate model in a straight line movement with a
