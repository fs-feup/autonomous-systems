...
class ExtendedKalmanFilter {
  Eigen::MatrixXd A; /**< Recursive state transition matrix: describes how the state evolves from one time step to the next */
  Eigen::MatrixXd B; /**< Motion to state matrix: describes how the controls/odometry affect the state */
  Eigen::MatrixXd C; /**< Measuremenets to state matrix: describes how the sensor measurements affect the state */
  ...
  public:
     ...
     * 
     * @param A - Recursive state transition matrix: describes how the state evolves from one time step to the next
     * @param B - Motion to state matrix: describes how the controls/odometry affect the state
     * @param C - Measuremenets to state matrix: describes how the sensor measurements affect the state
     * @param R - Motion noise matrix
     * @param Q - Measurement noise matrix
     */
    ExtendedKalmanFilter(const Eigen::MatrixXd& A,
