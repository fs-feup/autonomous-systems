...
Eigen::Vector2f ObservationModel::inverse_observation_model(const Eigen::VectorXf& expected_state, const ObservationData& observation_data) const {
...
Eigen::Vector2f ObservationModel::observation_model(const Eigen::VectorXf& expected_state, const unsigned int landmark_index) const {
...
Eigen::MatrixXf ObservationModel::get_jacobian(const unsigned int landmark_index, const unsigned int state_size) const {
