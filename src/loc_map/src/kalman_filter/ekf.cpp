...
ExtendedKalmanFilter::ExtendedKalmanFilter(const MotionModel& motion_model,
  ...
  switch (mission) {
    case Mission::skidpad: {
      ...
      // this->X(65) = 12.082;
      // this->X(66) = 2.08;
      // this->X(67) = 22.512999999999998;
      // this->X(68) = -1.612;
      // this->X(69) = 24.816000000000003;
      // this->X(70) = -5.059;
      // this->X(71) = 25.625;
      // this->X(72) = -9.125;
      // this->X(73) = 24.816000000000003;
      // this->X(74) = -13.191;
      // this->X(75) = 22.512999999999998;
      // this->X(76) = -16.638;
      // this->X(77) = 19.066;
      // this->X(78) = -18.941;
      // this->X(79) = 15.0;
      // this->X(80) = -19.75;
      // this->X(81) = 10.934000000000001;
      // this->X(82) = -18.941;
      // this->X(83) = 7.487;
      // this->X(84) = -16.638;
      // this->X(85) = 5.183999999999999;
      // this->X(86) = -13.191;
      // this->X(87) = 4.375;
      // this->X(88) = -9.125;
      // this->X(89) = 5.183999999999999;
      // this->X(90) = -5.059;
      // this->X(91) = 7.487;
      // this->X(92) = -1.612;
      // this->X(93) = 22.512999999999998;
      // this->X(94) = 1.612;
      // this->X(95) = 24.816000000000003;
      // this->X(96) = 5.059;
      // this->X(97) = 25.625;
      // this->X(98) = 9.125;
      // this->X(99) = 24.816000000000003;
      // this->X(100) = 13.191;
      // this->X(101) = 22.512999999999998;
      // this->X(102) = 16.638;
      // this->X(103) = 19.066;
      // this->X(104) = 18.941;
      // this->X(105) = 15.0;
      // this->X(106) = 19.75;
      // this->X(107) = 10.934000000000001;
      // this->X(108) = 18.941;
      // this->X(109) = 7.487;
      // this->X(110) = 16.638;
      // this->X(111) = 5.183999999999999;
      // this->X(112) = 13.191;
      // this->X(113) = 4.375;
      // this->X(114) = 9.125;
      // this->X(115) = 5.183999999999999;
      // this->X(116) = 5.059;
      // this->X(117) = 7.487;
      // this->X(118) = 1.612;
