...
TEST_F(ExecTimeTest, PUBLISH_INTEGRATION_TEST_EKF_CORR_10) {
  ...
  std::ofstream file("../../src/loc_map/test/integration_test.csv", std::ios::app);
  file << "LOC_MAP, EKF Correction Step, 10 and 10 From \"perception\", " << duration.count()
       << "\n";
  file.close();
...
TEST_F(ExecTimeTest, PUBLISH_INTEGRATION_TEST_EKF_CORR_50) {
  ...
  std::ofstream file("../../src/loc_map/test/integration_test.csv", std::ios::app);
  file << "LOC_MAP, EKF Correction Step, 50 and 10 From \"perception\", " << duration.count()
       << "\n";
  file.close();
...
TEST_F(ExecTimeTest, PUBLISH_INTEGRATION_TEST_EKF_CORR_100) {
  ...
  std::ofstream file("../../src/loc_map/test/integration_test.csv", std::ios::app);
  file << "LOC_MAP, EKF Correction Step, 100 and 10 From \"perception\", " << duration.count()
       << "\n";
  file.close();
