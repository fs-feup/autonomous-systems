...
SENode::SENode(ExtendedKalmanFilter *ekf, ConeMap *perception_map, MotionUpdate *imu_update,
...
void SENode::_wheel_speeds_subscription_callback(double lb_speed, double lf_speed, double rb_speed,
  ...
  MotionUpdate motion_prediction_data = SENode::odometry_to_velocities_transform(
...
void SENode::set_mission(Mission mission) {
...
void SENode::_update_and_publish() {  // Currently unused, as correction step and
...
MotionUpdate SENode::odometry_to_velocities_transform(double lb_speed,
