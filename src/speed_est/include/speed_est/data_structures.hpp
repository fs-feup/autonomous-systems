#ifndef SRC_SPEED_EST_INCLUDE_SPEED_EST_DATA_STRUCTURES_HPP_
#define SRC_SPEED_EST_INCLUDE_SPEED_EST_DATA_STRUCTURES_HPP_
...
#endif  // SRC_SPEED_EST_INCLUDE_SPEED_EST_DATA_STRUCTURES_HPP_
