#ifndef SRC_SPEED_EST_INCLUDE_SPEED_EST_LM_SUBSCRIBER_HPP_
#define SRC_SPEED_EST_INCLUDE_SPEED_EST_LM_SUBSCRIBER_HPP_
...
#endif  // SRC_SPEED_EST_INCLUDE_SPEED_EST_LM_SUBSCRIBER_HPP_