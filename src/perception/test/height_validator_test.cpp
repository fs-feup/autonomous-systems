...
TEST_F(HeightValidatorTest, ConeWithinSmallHeightThreshold) {
  HeightValidator validator(0.1, 0.5, 0.375, 0.5);

  auto point_cloud = std::make_shared<pcl::PointCloud<pcl::PointXYZI>>();
  point_cloud->points.emplace_back(0.0, 0.0, 0.3, 0);
...
TEST_F(HeightValidatorTest, ConeWithinLargeHeightThreshold) {
  ...
  auto point_cloud = std::make_shared<pcl::PointCloud<pcl::PointXYZI>>();
  point_cloud->points.emplace_back(0.0, 0.0, 0.4, 0);
...
TEST_F(HeightValidatorTest, ConeExceedsHeightThreshold) {
  ...
  auto point_cloud = std::make_shared<pcl::PointCloud<pcl::PointXYZI>>();
  point_cloud->points.emplace_back(0.0, 0.0, 0.6, 0);
...
TEST_F(HeightValidatorTest, ConeBelowHeightThreshold) {
  ...
  auto point_cloud = std::make_shared<pcl::PointCloud<pcl::PointXYZI>>();
  point_cloud->points.emplace_back(0.0, 0.0, 0.03, 0);
...
TEST_F(HeightValidatorTest, ConeNearMinimumHeight) {
  ...
  auto point_cloud = std::make_shared<pcl::PointCloud<pcl::PointXYZI>>();
  point_cloud->points.emplace_back(0.0, 0.0, 0.15, 0);
