...
HeightValidator::HeightValidator(double min_height, double max_height, double small_max_height)
    : _min_height_(min_height), _max_height_(max_height), _small_max_height_(small_max_height) {}
...
bool HeightValidator::coneValidator(Cluster* cone_point_cloud, Plane& plane) const {
  ...
  return plane.get_distance_to_point(maxPoint) < _max_height_ &&
