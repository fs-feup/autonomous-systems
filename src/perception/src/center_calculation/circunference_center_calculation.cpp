...
Eigen::Vector4f CircunferenceCenterCalculation::calculate_center(
    pcl::PointCloud<PointXYZIR>::Ptr point_cloud, const Plane& plane) const {
  ...
  std::vector<PointXYZIR> closest_points(3);
