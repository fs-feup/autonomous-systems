#ifndef SRC_PLANNING_INCLUDE_UTILS_CONE_COLORING_CONFIG_HPP_
#define SRC_PLANNING_INCLUDE_UTILS_CONE_COLORING_CONFIG_HPP_
...
#endif  // SRC_PLANNING_INCLUDE_UTILS_CONE_COLORING_CONFIG_HPP_