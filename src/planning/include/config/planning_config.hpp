...
struct PlanningConfig {
  ...
  explicit PlanningConfig(const PlanningParameters &params) {
    ...
    outliers.precision = params.outliers_spline_precision_;
    outliers.coeffs_ratio = params.outliers_spline_coeffs_ratio_;

    path_calculation.dist_threshold = params.path_calculation_dist_threshold_;

    smoothing.order = params.smoothing_spline_order_;
    smoothing.precision = params.smoothing_spline_precision_;
    smoothing.coeffs_ratio = params.smoothing_spline_coeffs_ratio_;
