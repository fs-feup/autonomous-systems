...
std::string load_adapter_parameters(PlanningParameters& params) {
  ...
  params.angle_gain_ = adapter_node->declare_parameter("angle_gain", 6.1);
  params.distance_gain_ = adapter_node->declare_parameter("distance_gain", 5.01);
  params.ncones_gain_ = adapter_node->declare_parameter("ncones_gain", 4.1); 
  ...
  params.cost_max_ = adapter_node->declare_parameter("cost_max", 55.0);
