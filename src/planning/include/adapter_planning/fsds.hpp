...
class FsdsAdapter : public Adapter {
  ...
  rclcpp::Subscription</*tipo da mensagem de posicao*/>::SharedPtr fsds_position_subscription_;
 ...
 public:
  ...
  void pose_callback(const /*tipo da mensagem de posicao*/& msg) override;
