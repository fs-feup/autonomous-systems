...
class TestFormats(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected_velocities = (np.array([1.0, 1.0, 2.0]),)
        ...
        self.expected_stamped_message = np.array([1, 2, 1.5708])
    ...
    def test_format_vehicle_state_msg(self):
        ...
        npt.assert_array_almost_equal(
            format_position, self.expected_position[0], decimal=6
        )
        npt.assert_array_almost_equal(
            format_velocities, self.expected_velocities[0], decimal=6
        )
    ...
    def test_format_cone_array_msg(self):
        ...
        npt.assert_array_almost_equal(
            formated_position, self.expected_cone_array, decimal=6
        )
    ...
    def test_format_transform_stamped(self):
        ...
        npt.assert_array_almost_equal(
            formated_msg, self.expected_stamped_message, decimal=4
        )
    ...
    def test_format_path_point_array(self):
        ...
        npt.assert_array_almost_equal(
            formated_msg, self.expected_path_point_array, decimal=6
        )
