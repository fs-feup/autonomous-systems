...
TEST(ODOMETRY_SUBSCRIBER, CONVERSION_TEST) {
  ...
  std::pair<double, double> velocity_data =
      common_lib::vehicle_dynamics::odometry_to_velocities_transform(rl_speed, rr_speed, fl_speed,
  ...
  velocity_data = common_lib::vehicle_dynamics::odometry_to_velocities_transform(
