...
struct SLAMSolverParameters {
  double observation_x_noise_ = 0.1;  //< Noise in the x direction of the observations' position
  double observation_y_noise_ = 0.1;  //< Noise in the y direction of the observations' position
