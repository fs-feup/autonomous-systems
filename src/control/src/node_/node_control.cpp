...
void Control::publish_control(const custom_interfaces::msg::Pose& vehicle_state_msg) {
  ...
  RCLCPP_DEBUG(rclcpp::get_logger("control"), "Rear Axis: %lf",
               this->point_solver_.vehicle_pose_.rear_axis_);
  RCLCPP_DEBUG(rclcpp::get_logger("control"), "CG to rear axis Rear Axis: %f",
               this->point_solver_.dist_cg_2_rear_axis_);
  RCLCPP_DEBUG(rclcpp::get_logger("control"), "Position: (%f, %f)",
