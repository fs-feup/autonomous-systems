...
TEST(PurePursuitTests, Test_calculate_alpha_1) {
  ...
  double alpha = ctrl.lat_controller_.calculate_alpha(vehicle_rear_wheel, vehicle_cg,
...
TEST(PurePursuitTests, Test_pp_steering_control_law_1) {
  ...
  double steering_cmd = ctrl.lat_controller_.pp_steering_control_law(
      rear_axis, cg, lookahead_point, dist_cg_2_rear_axis, ctrl.lat_controller_.wheel_base_,
      ctrl.lat_controller_.max_steering_angle_, ctrl.lat_controller_.min_steering_angle_);
